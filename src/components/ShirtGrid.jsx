...
const screenshots = [
  ...
  { src: "./samples/shirt22.png", alt: ""},
  { src: "./samples/shirt10.png", alt: ""},
  { src: "./samples/shirt11.png", alt: ""},
  { src: "./samples/shirt12.png", alt: ""},
  { src: "./samples/shirt13.png", alt: ""},
  { src: "./samples/shirt14.png", alt: ""},
  { src: "./samples/shirt16.png", alt: ""},
  { src: "./samples/shirt17.png", alt: ""},
  { src: "./samples/shirt18.png", alt: ""},
  { src: "./samples/shirt19.png", alt: ""},
  { src: "./samples/shirt20.png", alt: ""},
  { src: "./samples/shirt21.png", alt: ""},
];
